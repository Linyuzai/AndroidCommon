...
public class PercentXController extends LinearLayout implements AbsController {

    private SeekBar seekBar;
    private Painter painter;
    private TargetEntity entity;

    public PercentXController(Context context, EasonIcon icon) {
        super(context);
    ...
    public void setEntity(TargetEntity entity) {
        ...
        seekBar.setProgress(entity.getPercentX());
    }
}
