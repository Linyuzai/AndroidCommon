...
public class CubicPainter extends PathPainter {
    ...
    public void setControlPoint(float x1, float y1, float x2, float y2) {
        controlPoint[0].set(x1, y1);
        controlPoint[1].set(x2, y2);
    }
}
