...
@AuxiliaryColorField
@RoundRectField
public class AddSolidRectPainter extends SupportEasonPainterSet implements RoundRectSupport, AuxiliaryColorSupport {

    public AddSolidRectPainter(int auxiliaryColor) {
        this(0.5f, auxiliaryColor);
    }

    public AddSolidRectPainter(float auxiliaryScale, int auxiliaryColor) {
        this(auxiliaryScale, auxiliaryColor, 0f, 0f, 0f, 0f);
    }

    public AddSolidRectPainter(int auxiliaryColor, float leftTopRound, float leftBottomRound,
    ...
    public AddSolidRectPainter(float auxiliaryScale, int auxiliaryColor, float leftTopRound,
