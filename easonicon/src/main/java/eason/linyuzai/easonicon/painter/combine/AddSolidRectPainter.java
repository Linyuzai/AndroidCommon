...
public class AddSolidRectPainter extends EasonPainterSet {
    ...
    public AddSolidRectPainter(@AuxiliaryColorField int auxiliaryColor) {
        this(0.5f, auxiliaryColor);
    }

    public AddSolidRectPainter(@AuxiliaryScaleField float auxiliaryScale, @AuxiliaryColorField int auxiliaryColor) {
    ...
    public AddSolidRectPainter(@AuxiliaryScaleField float auxiliaryScale,
