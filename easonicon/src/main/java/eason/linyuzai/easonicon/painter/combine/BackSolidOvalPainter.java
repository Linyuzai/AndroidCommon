...
@AuxiliaryScaleField
@AuxiliaryColorField
public class BackSolidOvalPainter extends SupportEasonPainterSet implements AuxiliaryColorSupport {

    public BackSolidOvalPainter(int auxiliaryColor) {
        this(0.5f, auxiliaryColor);
    }

    public BackSolidOvalPainter(float auxiliaryScale, int auxiliaryColor) {
