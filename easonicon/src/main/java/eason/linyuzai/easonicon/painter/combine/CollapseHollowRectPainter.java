...
@AuxiliaryScaleField
@RoundRectField
public class CollapseHollowRectPainter extends SupportEasonPainterSet implements RoundRectSupport {
    ...
    public CollapseHollowRectPainter(float leftTopRound, float leftBottomRound, float rightTopRound,
                                     float rightBottomRound) {
        this(0.5f, leftTopRound, leftBottomRound, rightTopRound, rightBottomRound);
    }

    public CollapseHollowRectPainter(float auxiliaryScale, float leftTopRound, float leftBottomRound,
