...
@AuxiliaryColorField
@RoundRectField
public class CollapseSolidRectPainter extends SupportEasonPainterSet implements RoundRectSupport {

    public CollapseSolidRectPainter(int auxiliaryColor) {
        this(0.5f, auxiliaryColor);
    }

    public CollapseSolidRectPainter(float auxiliaryScale, int auxiliaryColor) {
        this(auxiliaryScale, auxiliaryColor, 0f, 0f, 0f, 0f);
    }

    public CollapseSolidRectPainter(int auxiliaryColor, float leftTopRound, float leftBottomRound,
    ...
    public CollapseSolidRectPainter(float auxiliaryScale, int auxiliaryColor, float leftTopRound,
