...
@AuxiliaryColorField
@RoundRectField
public class CorrectRectPainter extends SupportEasonPainterSet implements AuxiliaryScaleSupport, AuxiliaryColorSupport, RoundRectSupport {

    public CorrectRectPainter() {
        this(Color.WHITE);
    }
    ...
    public CorrectRectPainter(float auxiliaryScale, int auxiliaryColor) {
        this(auxiliaryScale, auxiliaryColor, 0f, 0f, 0f, 0f);
    }

    public CorrectRectPainter(int auxiliaryColor, float leftTopRound, float leftBottomRound,
    ...
    public CorrectRectPainter(float auxiliaryScale, int auxiliaryColor, float leftTopRound,
