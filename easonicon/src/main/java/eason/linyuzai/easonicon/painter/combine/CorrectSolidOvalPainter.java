...
@AuxiliaryScaleField
@AuxiliaryColorField
public class CorrectSolidOvalPainter extends SupportEasonPainterSet implements AuxiliaryColorSupport{

    public CorrectSolidOvalPainter(int auxiliaryColor) {
        this(0.5f, auxiliaryColor);
    }

    public CorrectSolidOvalPainter(float auxiliaryScale, int auxiliaryColor) {
