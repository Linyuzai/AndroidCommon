...
@AuxiliaryScaleField
@AuxiliaryColorField
public class DownArrowSolidOvalPainter extends SupportEasonPainterSet implements AuxiliaryColorSupport{

    public DownArrowSolidOvalPainter(int auxiliaryColor) {
        this(0.5f, auxiliaryColor);
    }

    public DownArrowSolidOvalPainter(float auxiliaryScale, int auxiliaryColor) {
