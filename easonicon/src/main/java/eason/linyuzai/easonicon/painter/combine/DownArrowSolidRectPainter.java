...
@AuxiliaryColorField
@RoundRectField
public class DownArrowSolidRectPainter extends SupportEasonPainterSet implements RoundRectSupport, AuxiliaryColorSupport {

    public DownArrowSolidRectPainter(int auxiliaryColor) {
        this(0.5f, auxiliaryColor);
    }

    public DownArrowSolidRectPainter(float auxiliaryScale, int auxiliaryColor) {
        this(auxiliaryScale, auxiliaryColor, 0f, 0f, 0f, 0f);
    }

    public DownArrowSolidRectPainter(int auxiliaryColor, float leftTopRound, float leftBottomRound,
    ...
    public DownArrowSolidRectPainter(float auxiliaryScale, int auxiliaryColor, float leftTopRound,
