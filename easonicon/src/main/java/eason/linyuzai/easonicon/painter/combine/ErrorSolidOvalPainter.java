...
@AuxiliaryScaleField
@AuxiliaryColorField
public class ErrorSolidOvalPainter extends SupportEasonPainterSet implements AuxiliaryColorSupport{

    public ErrorSolidOvalPainter(int auxiliaryColor) {
        this(0.5f, auxiliaryColor);
    }

    public ErrorSolidOvalPainter(float auxiliaryScale, int auxiliaryColor) {
