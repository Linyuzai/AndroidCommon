...
public class ExpandHollowRectPainter extends EasonPainterSet {
    ...
    public ExpandHollowRectPainter(@AuxiliaryScaleField float auxiliaryScale) {
        this(auxiliaryScale, 0f, 0f, 0f, 0f);
    }

    public ExpandHollowRectPainter(@RoundField float leftTopRound, @RoundField float leftBottomRound,
    ...
    public ExpandHollowRectPainter(@AuxiliaryScaleField float auxiliaryScale, @RoundField float leftTopRound,
