...
@AuxiliaryScaleField
@AuxiliaryColorField
public class ExpandSolidOvalPainter extends SupportEasonPainterSet implements AuxiliaryColorSupport{

    public ExpandSolidOvalPainter(int auxiliaryColor) {
        this(0.5f, auxiliaryColor);
    }

    public ExpandSolidOvalPainter(float auxiliaryScale, int auxiliaryColor) {
