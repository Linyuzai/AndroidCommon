...
@AuxiliaryScaleField
@RoundRectField
public class LeftArrowHollowRectPainter extends SupportEasonPainterSet implements RoundRectSupport {

    public LeftArrowHollowRectPainter() {
        this(0.5f);
    }

    public LeftArrowHollowRectPainter(float auxiliaryScale) {
        this(auxiliaryScale, 0f, 0f, 0f, 0f);
    }

    public LeftArrowHollowRectPainter(float leftTopRound, float leftBottomRound, float rightTopRound,
                                      float rightBottomRound) {
        this(0.5f, leftTopRound, leftBottomRound, rightTopRound, rightBottomRound);
    }

    public LeftArrowHollowRectPainter(float auxiliaryScale, float leftTopRound, float leftBottomRound,
