...
@AuxiliaryScaleField
@AuxiliaryColorField
public class LeftArrowSolidOvalPainter extends SupportEasonPainterSet implements AuxiliaryColorSupport{

    public LeftArrowSolidOvalPainter(int auxiliaryColor) {
        this(0.5f, auxiliaryColor);
    }

    public LeftArrowSolidOvalPainter(float auxiliaryScale, int auxiliaryColor) {
