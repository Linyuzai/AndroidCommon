...
public class LeftArrowSolidRectPainter extends EasonPainterSet {
    ...
    public LeftArrowSolidRectPainter(@AuxiliaryColorField int auxiliaryColor) {
        this(0.5f, auxiliaryColor);
    }

    public LeftArrowSolidRectPainter(@AuxiliaryScaleField float auxiliaryScale, @AuxiliaryColorField int auxiliaryColor) {
    ...
    public LeftArrowSolidRectPainter(@AuxiliaryScaleField float auxiliaryScale,
