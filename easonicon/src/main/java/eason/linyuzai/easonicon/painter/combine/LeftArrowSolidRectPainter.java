...
@AuxiliaryColorField
@RoundRectField
public class LeftArrowSolidRectPainter extends SupportEasonPainterSet implements RoundRectSupport, AuxiliaryColorSupport {

    public LeftArrowSolidRectPainter(int auxiliaryColor) {
        this(0.5f, auxiliaryColor);
    }

    public LeftArrowSolidRectPainter(float auxiliaryScale, int auxiliaryColor) {
        this(auxiliaryScale, auxiliaryColor, 0f, 0f, 0f, 0f);
    }

    public LeftArrowSolidRectPainter(int auxiliaryColor, float leftTopRound, float leftBottomRound,
    ...
    public LeftArrowSolidRectPainter(float auxiliaryScale, int auxiliaryColor, float leftTopRound,
