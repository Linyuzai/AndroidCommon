...
@AuxiliaryScaleField
@RoundRectField
public class MinusHollowRectPainter extends SupportEasonPainterSet implements RoundRectSupport {

    public MinusHollowRectPainter() {
        this(0.5f);
    }

    public MinusHollowRectPainter(float auxiliaryScale) {
        this(auxiliaryScale, 0f, 0f, 0f, 0f);
    }

    public MinusHollowRectPainter(float leftTopRound, float leftBottomRound, float rightTopRound,
                                  float rightBottomRound) {
        this(0.5f, leftTopRound, leftBottomRound, rightTopRound, rightBottomRound);
    }

    public MinusHollowRectPainter(float auxiliaryScale, float leftTopRound, float leftBottomRound,
