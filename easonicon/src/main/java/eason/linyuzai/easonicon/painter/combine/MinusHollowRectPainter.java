...
public class MinusHollowRectPainter extends EasonPainterSet {

    public MinusHollowRectPainter() {
        this(0.5f);
    }

    public MinusHollowRectPainter(@AuxiliaryScaleField float auxiliaryScale) {
        this(auxiliaryScale, 0f, 0f, 0f, 0f);
    }

    public MinusHollowRectPainter(@RoundField float leftTopRound, @RoundField float leftBottomRound,
    ...
    public MinusHollowRectPainter(@AuxiliaryScaleField float auxiliaryScale, @RoundField float leftTopRound,
