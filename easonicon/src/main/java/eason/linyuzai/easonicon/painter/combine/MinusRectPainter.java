...
@AuxiliaryColorField
@RoundRectField
public class MinusRectPainter extends SupportEasonPainterSet implements AuxiliaryScaleSupport, AuxiliaryColorSupport, RoundRectSupport {

    public MinusRectPainter() {
        this(Color.WHITE);
    }

    public MinusRectPainter(int auxiliaryColor) {
        this(0.5f, auxiliaryColor);
    }

    public MinusRectPainter(float auxiliaryScale, int auxiliaryColor) {
        this(auxiliaryScale, auxiliaryColor, 0f, 0f, 0f, 0f);
    }

    public MinusRectPainter(int auxiliaryColor, float leftTopRound, float leftBottomRound,
    ...
    public MinusRectPainter(float auxiliaryScale, int auxiliaryColor, float leftTopRound,
