...
@AuxiliaryColorField
@RoundRectField
public class MinusSolidRectPainter extends SupportEasonPainterSet implements RoundRectSupport, AuxiliaryColorSupport {

    public MinusSolidRectPainter(int auxiliaryColor) {
        this(0.5f, auxiliaryColor);
    }

    public MinusSolidRectPainter(float auxiliaryScale, int auxiliaryColor) {
        this(auxiliaryScale, auxiliaryColor, 0f, 0f, 0f, 0f);
    }

    public MinusSolidRectPainter(int auxiliaryColor, float leftTopRound, float leftBottomRound,
    ...
    public MinusSolidRectPainter(float auxiliaryScale, int auxiliaryColor, float leftTopRound,
