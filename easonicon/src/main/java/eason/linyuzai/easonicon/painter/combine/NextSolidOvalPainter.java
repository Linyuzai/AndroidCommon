...
@AuxiliaryScaleField
@AuxiliaryColorField
public class NextSolidOvalPainter extends SupportEasonPainterSet implements AuxiliaryColorSupport{

    public NextSolidOvalPainter(int auxiliaryColor) {
        this(0.5f, auxiliaryColor);
    }

    public NextSolidOvalPainter(float auxiliaryScale, int auxiliaryColor) {
