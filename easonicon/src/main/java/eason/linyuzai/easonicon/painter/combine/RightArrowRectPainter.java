...
@AuxiliaryColorField
@RoundRectField
public class RightArrowRectPainter extends SupportEasonPainterSet implements AuxiliaryScaleSupport, AuxiliaryColorSupport, RoundRectSupport {

    public RightArrowRectPainter() {
        this(Color.WHITE);
    }

    public RightArrowRectPainter(int auxiliaryColor) {
        this(0.5f, auxiliaryColor);
    }

    public RightArrowRectPainter(float auxiliaryScale, int auxiliaryColor) {
        this(auxiliaryScale, auxiliaryColor, 0f, 0f, 0f, 0f);
    }

    public RightArrowRectPainter(int auxiliaryColor, float leftTopRound, float leftBottomRound,
    ...
    public RightArrowRectPainter(float auxiliaryScale, int auxiliaryColor, float leftTopRound,
