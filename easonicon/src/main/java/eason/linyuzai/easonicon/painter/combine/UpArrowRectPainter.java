...
@AuxiliaryColorField
@RoundRectField
public class UpArrowRectPainter extends SupportEasonPainterSet implements AuxiliaryScaleSupport, AuxiliaryColorSupport, RoundRectSupport {

    public UpArrowRectPainter() {
        this(Color.WHITE);
    }

    public UpArrowRectPainter(int auxiliaryColor) {
        this(0.5f, auxiliaryColor);
    }

    public UpArrowRectPainter(float auxiliaryScale, int auxiliaryColor) {
        this(auxiliaryScale, auxiliaryColor, 0f, 0f, 0f, 0f);
    }

    public UpArrowRectPainter(int auxiliaryColor, float leftTopRound, float leftBottomRound, float rightTopRound,
