...
@AuxiliaryColorField
@RoundRectField
public class UpArrowSolidRectPainter extends SupportEasonPainterSet implements RoundRectSupport, AuxiliaryColorSupport {

    public UpArrowSolidRectPainter(int auxiliaryColor) {
        this(0.5f, auxiliaryColor);
    }

    public UpArrowSolidRectPainter(float auxiliaryScale, int auxiliaryColor) {
        this(auxiliaryScale, auxiliaryColor, 0f, 0f, 0f, 0f);
    }

    public UpArrowSolidRectPainter(int auxiliaryColor, float leftTopRound, float leftBottomRound, float rightTopRound,
                                   float rightBottomRound) {
        this(0.5f, auxiliaryColor, leftTopRound, leftBottomRound, rightTopRound, rightBottomRound);
    }

    public UpArrowSolidRectPainter(float auxiliaryScale, int auxiliaryColor, float leftTopRound,
